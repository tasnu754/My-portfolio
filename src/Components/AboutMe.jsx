...
const AboutMe = () => {
    return (
      <div className="flex flex-col-reverse gap-10 lg:flex-row mt-16" id="about">
        ...
        <div className=" flex-1 lg:px-20 ">
          <h2 className="text-center text-3xl font-bold py-4 lg:py-0 lg:pb-4">About Me</h2>
          <p className="text-xl">
          ...
          <div className="flex md:gap-10">
            <div className="pt-10 space-y-4 text-sm md:text-xl text-[#0ef]">
              ...
              {/* <p className="pb-[20px] md:pb-0">
                <MdOutlineCastForEducation className="inline-block mr-2"></MdOutlineCastForEducation>
                Education:
              </p> */}
